  ...
  <body class="p-3 m-0 border-0 bd-example">
    ...
    <center>
      <div class="card mb-3" style="max-width: 58rem; background-color:#00000090">
        <p></p>
        <p></p>
        <h2 style="font-family: 'KrinkesDecorPERSONAL'; color:#E2FAFF" class="card-title"><b>CREAR CLIENTE</b></h2>
        <center>
        ...
        <h5 style="font-family: 'Times New Roman', Times, serif; color:#C6D6F5" class="card-text"><b> Ingrese
          el Número de Documento y Contraseña para el Cliente</b></h5>
        <p></p>
        <form method="post" class="form-signin" action="<%=request.getContextPath()%>/ServletAdministrador">
